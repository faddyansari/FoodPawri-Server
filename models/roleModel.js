...
var Roles = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, this.db.createCollection('roles')];
                    case 1:
                        //   this.db = await TicketsDB.connect();
                        _a.collection = _b.sent();
                        Roles.initialized = true;
                        return [2 /*return*/, Roles.initialized];
                    case 2:
                        error_1 = _b.sent();
                        console.log(error_1);
    ...
    Roles.Destroy = function () {
        this.db = undefined;
        this.collection = undefined;
    };
    Roles.getTicketByID = function (nsp, tid) {
        return __awaiter(this, void 0, void 0, function () {
            var error_2;
